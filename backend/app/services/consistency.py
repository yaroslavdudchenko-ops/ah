...
нарушения GCP ICH E6 R2, GCP ЕАЭС (Решение ЕЭК №79), 61-ФЗ, Приказа Минздрава №353н.
...
Верни JSON строго в формате:
{
  ...
  "gcp_hints": [
    {"category": "ICH E6|GCP ЕАЭС|61-ФЗ|Приказ №353н", "priority": "high|medium|low", "recommendation": <str>, "gcp_reference": <str>}
  ],
  "summary": <str>,
  "rf_summary": <str>
}
