...
**Version:** 1.1.0 | **Date:** 2026-04-23 | **Status:** Draft  
...
CREATE TABLE protocols (
  ...
  status VARCHAR(20) DEFAULT 'draft' CHECK (status IN ('draft', 'review', 'final')),
  created_at TIMESTAMP DEFAULT NOW(),
...
CREATE TABLE audit_log (
  ...
  action VARCHAR(50) NOT NULL,    -- CREATE | UPDATE | GENERATE | EXPORT | CHECK
