...
При выпуске новой версии документа старая копия переносится в `docs/archive/` с суффиксом версии в имени файла.
...
| `CHECKPOINT.md` | 9.0.0 | 2026-04-24 | Active |
